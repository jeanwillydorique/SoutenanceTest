...
{{-- Old version 
<div class="adminSidebar d-flex justify-content-center flex-column">
    <div class="identity d-flex justify-content-center flex-column mb-4">
        <div class="d-flex justify-content-center"> Bonjour {{$user->name}}</div>
    </div>

    <div class="list-group list-group-flush">
        <a href="allusers" class="list-group-item list-group-item-action">Employes</a>
        <a href="allbooks" class="list-group-item list-group-item-action">Livres</a>
        <a href="#" class="list-group-item list-group-item-action">Jeux</a>
        ...
        <div class="card  border-0">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body text-decoration-none d-flex flex-column">
                    ...
                    <a href="/createuser">Créer un utilisateur</a>
                </div>
            </div>
        </div>
    </div>
    <div class="card  border-0">
            <div class="card-header bg-transparent border-0" id="headingTwo">
              <h2 class="mb-0 justify-content-center">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                <div class="card-body text-decoration-none d-flex flex-column">
                    <a href="/allbooks">Tous les livres</a>
                    <a href="/createbook">Créer un livre</a>
                </div>
            </div>
    </div>
</div> --}}
